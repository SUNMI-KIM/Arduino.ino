...
// Servo adjustment
#define _DUTY_MAX 1882  // Servo angle: D degree
#define _DUTY_NEU 1505  // Servo angle: 0 degree
#define _DUTY_MIN 1220   // Servo angle: E degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 869 + -4.17 * a_value + pow(10, -3) * 7.13 * a_value * a_value + -4.28 * pow(10, -6) *a_value * a_value * a_value;
}
